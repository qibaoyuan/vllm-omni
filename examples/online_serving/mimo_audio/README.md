...
### Launch the Server
```bash
export MODEL_PATH= "/app/MiMo-Audio-7B-Instruct"
export MIMO_AUDIO_TOKENIZER_PATH="/app/MiMo-Audio-Tokenizer"
export MIMO_AUDIO_TOKENIZER_CONFIG_PATH="/app/MiMo-Audio-Tokenizer"

export STAGE_CONFIGS_PATH="/app/vllm-omni-dev/vllm_omni/model_executor/stage_configs/mimo_audio/mimo_audio_llm_code2wav.yaml"
```


```bash
export PYTHONPATH=/app/vllm-omni-dev:${PYTHONPATH}
