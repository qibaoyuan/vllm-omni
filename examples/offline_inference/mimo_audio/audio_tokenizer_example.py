...
export MIMO_AUDIO_ATTN_IMPLEMENTATION="sdpa"
export MIMO_AUDIO_ATTN_IMPLEMENTATION="flash"
export MIMO_AUDIO_ATTN_IMPLEMENTATION="eager"
export MIMO_AUDIO_ATTN_IMPLEMENTATION="auto"
...
--audio-path /mnt/user/qibaoyuan/vllm-omni-qby/examples/offline_inference/mimo_audio/freetalk_朋友_剪.wav \
--output-path reconstructed_${MIMO_AUDIO_ATTN_IMPLEMENTATION}.wav \
--streaming-output-path reconstructed_streaming_${MIMO_AUDIO_ATTN_IMPLEMENTATION}.wav
